var olcs_unused_var = function(e) {
    ...
    function o(e, t, i) { return e.on(t, i) }
    r.obj = function(e) { return e }, r.supportsImageRenderingPixelatedResult_ = void 0, r.imageRenderingValueResult_ = void 0, r.supportsImageRenderingPixelated = function() {
    ...
    }, r.imageRenderingValue = function() { return r.supportsImageRenderingPixelated(), r.imageRenderingValueResult_ || "" }, r.getSourceProjection = function(e) { return e.get("olcs.projection") || e.getProjection() };
    var a = 0;

    function s(e) { return e.olcs_uid || (e.olcs_uid = ++a) }

    function u(e) { var t = Cesium.GroundPolylinePrimitive; return t && t.isSupported(e) }
    var l, c = r,
        h = i(11),
        m = i(12),
        d = i.n(m),
        ...
        T = i(17),
        L = i(18),
        P = (l = new L.Tile({ projection: "EPSG:3857", wrapX: !0 }).getTileCoordForTileUrlFunction([6, -31, 22])) && 33 === l[1] && 22 === l[2],
        R = function() {
            function e(e, t, i) {
                var n = this;
                this.source_ = t, this.projection_ = null, this.fallbackProj_ = i || null, this.ready_ = !1, this.tilingScheme_ = null, this.rectangle_ = null, this.map_ = e, this.shouldRequestNextLevel = !1;
            ...
            return t.handleSourceChanged_ = function(e) {
                if (!this.ready_ && "ready" == this.source_.getState()) {
                    this.projection_ = c.getSourceProjection(this.source_) || this.fallbackProj_;
                    var t = { numberOfLevelZeroTilesX: 1, numberOfLevelZeroTilesY: 1 };
                    if (null !== this.source_.tileGrid && this.source_.tileGrid.forEachTileCoord(this.projection_.getExtent(), 0, (function(e) {
                            e[0];
                            var i = e[1],
                                n = e[2];
                            t.numberOfLevelZeroTilesX = i + 1, t.numberOfLevelZeroTilesY = n + 1
                        })), this.projection_ == Object(n.get)("EPSG:4326")) this.shouldRequestNextLevel = 1 === t.numberOfLevelZeroTilesX && 1 === t.numberOfLevelZeroTilesY, this.tilingScheme_ = new Cesium.GeographicTilingScheme(t);
                    else {
                        if (this.projection_ != Object(n.get)("EPSG:3857")) return;
                        this.shouldRequestNextLevel = !1, this.tilingScheme_ = new Cesium.WebMercatorTilingScheme(t)
                    }
                ...
                var n = this.map_.getView().calculateExtent(this.map_.getSize()),
                    ...
                    o = { viewState: { zoom: this.shouldRequestNextLevel ? i + 1 : i, center: r }, extent: n },
                    a = this.source_.getAttributions();
                if (!a) return [];
                var s = a(o);
                return Array.isArray(s) || (s = [s]), s.map((function(e) { return new Cesium.Credit(e, !0) }))
            }, t.requestImage = function(e, t, i) {
                var n = this.source_.getTileUrlFunction();
                if (n && this.projection_) {
                    var r = this.shouldRequestNextLevel ? i + 1 : i,
                        o = t;
                    P || (o = -t - 1);
    ...
    var E = R,
        O = {
            computePixelSizeAtCoordinate: function(e, t) {
                ...
                return r.getPixelDimensions(n.clientWidth, n.clientHeight, o, e.pixelRatio, new Cesium.Cartesian2)
            },
            ...
            pickOnTerrainOrEllipsoid: function(e, t) { var i = e.camera.getPickRay(t); return e.globe.pick(i, e) || e.camera.pickEllipsoid(t) },
            ...
            extentToRectangle: function(e, t) { if (e && t) { var i = Object(n.transformExtent)(e, t, "EPSG:4326"); return Cesium.Rectangle.fromDegrees(i[0], i[1], i[2], i[3]) } return null },
            tileLayerToImageryLayer: function(e, t, i) {
                ...
                if (r instanceof y.a && r.getUrl() && r.getImageLoadFunction() === T.defaultImageLoadFunction) {
                    var o = { "olcs.proxy": r.get("olcs.proxy"), "olcs.extent": r.get("olcs.extent"), "olcs.projection": r.get("olcs.projection"), "olcs.imagesource": r };
                    (r = new S.a({ url: r.getUrl(), attributions: r.getAttributions(), projection: r.getProjection(), params: r.getParams() })).setProperties(o)
                }
                if (r instanceof b.a) {
                    ...
                    n = new Cesium.SingleTileImageryProvider({ url: r.getUrl(), rectangle: new Cesium.Rectangle.fromDegrees(r.getImageExtent()[0], r.getImageExtent()[1], r.getImageExtent()[2], r.getImageExtent()[3]) })
                }
                var u = {},
            ...
            ol4326CoordinateToCesiumCartesian: function(e) { var t = e; return t.length > 2 ? Cesium.Cartesian3.fromDegrees(t[0], t[1], t[2]) : Cesium.Cartesian3.fromDegrees(t[0], t[1]) },
            ol4326CoordinateArrayToCsCartesians: function(e) { for (var t = O.ol4326CoordinateToCesiumCartesian, i = [], n = 0; n < e.length; ++n) i.push(t(e[n])); return i },
            ...
            convertColorToCesium: function(e) {
                ...
                if (e instanceof CanvasPattern || e instanceof CanvasGradient) {
                    var t = document.createElement("canvas"),
                        i = t.getContext("2d");
                    return t.width = t.height = 256, i.fillStyle = e, i.fillRect(0, 0, t.width, t.height), new Cesium.ImageMaterialProperty({ image: t })
                }
            },
            ...
            normalizeView: function(e, t) {
                ...
                e.setRotation(t), e.constrainResolution ? e.setResolution(e.constrainResolution(i)) : e.setResolution(e.getConstrainedResolution(i))
            },
    ...
    function A(e, t) { var i; if ("undefined" == typeof Symbol || null == e[Symbol.iterator]) { if (Array.isArray(e) || (i = function(e, t) { if (!e) return; if ("string" == typeof e) return G(e, t); var i = Object.prototype.toString.call(e).slice(8, -1); "Object" === i && e.constructor && (i = e.constructor.name); if ("Map" === i || "Set" === i) return Array.from(e); if ("Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i)) return G(e, t) }(e)) || t && e && "number" == typeof e.length) { i && (e = i); var n = 0; return function() { return n >= e.length ? { done: !0 } : { done: !1, value: e[n++] } } } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.") } return (i = e[Symbol.iterator]()).next.bind(i) }
    ...
    var I = function() {
            function e(e) { this.ol3d = e, this.scene_ = e.getCesiumScene(), this.canvas_ = this.scene_.canvas, this._boundNotifyRepaintRequired = this.notifyRepaintRequired.bind(this), this.repaintEventNames_ = ["mousemove", "mousedown", "mouseup", "touchstart", "touchend", "touchmove", "pointerdown", "pointerup", "pointermove", "wheel"], this.enable() }
            var t = e.prototype;
            return t.enable = function() {
                this.scene_.requestRenderMode = !0, this.scene_.maximumRenderTimeChange = 1e3;
                for (var e, t = A(this.repaintEventNames_); !(e = t()).done;) {
                    var i = e.value;
                    this.canvas_.addEventListener(i, this._boundNotifyRepaintRequired, !1)
                }
                ...
                for (var e, t = A(this.repaintEventNames_); !(e = t()).done;) {
                    var i = e.value;
                    this.canvas_.removeEventListener(i, this._boundNotifyRepaintRequired, !1)
                }
            ...
            }, t.restartRenderLoop = function() { this.notifyRepaintRequired() }, t.notifyRepaintRequired = function() { this.scene_.requestRender() }, e
        }(),
        M = i(1),
        F = i.n(M);

    function j(e) { return 180 * e / Math.PI }

    function k(e) { return e * Math.PI / 180 }
    var V = function() {
            function e(t, i) {
                var n = this;
                this.scene_ = t, this.cam_ = t.camera, this.map_ = i, this.view_ = null, this.viewListenKey_ = null, this.toLonLat_ = e.identityProjection, this.fromLonLat_ = e.identityProjection, this.tilt_ = 0, this.distance_ = 0, this.lastCameraViewMatrix_ = null, this.viewUpdateInProgress_ = !1, this.map_.on("change:view", (function(e) { n.setView_(n.map_.getView()) })), this.setView_(this.map_.getView())
            }
            ...
            return t.setView_ = function(t) {
                var i = this;
                if (this.view_ && (Object(M.unByKey)(this.viewListenKey_), this.viewListenKey_ = null), this.view_ = t, t) {
                    var r = Object(n.getTransform)(t.getProjection(), "EPSG:4326"),
                        o = Object(n.getTransform)("EPSG:4326", t.getProjection());
                    this.toLonLat_ = r, this.fromLonLat_ = o, this.viewListenKey_ = t.on("propertychange", (function(e) { return i.handleViewEvent_(e) })), this.readFromView()
                } else this.toLonLat_ = e.identityProjection, this.fromLonLat_ = e.identityProjection
            }, t.handleViewEvent_ = function(e) { this.viewUpdateInProgress_ || this.readFromView() }, t.setHeading = function(e) { this.view_ && this.view_.setRotation(e) }, t.getHeading = function() { if (this.view_) return this.view_.getRotation() || 0 }, t.setTilt = function(e) { this.tilt_ = e, this.updateCamera_() }, t.getTilt = function() { return this.tilt_ }, t.setDistance = function(e) { this.distance_ = e, this.updateCamera_(), this.updateView() }, t.getDistance = function() { return this.distance_ }, t.setCenter = function(e) { this.view_ && this.view_.setCenter(e) }, t.getCenter = function() { if (this.view_) return this.view_.getCenter() }, t.setPosition = function(e) {
                if (this.toLonLat_) {
                    var t = this.toLonLat_(e),
                        i = new Cesium.Cartographic(k(t[0]), k(t[1]), this.getAltitude());
                    this.cam_.setView({ destination: Cesium.Ellipsoid.WGS84.cartographicToCartesian(i) }), this.updateView()
                }
            }, t.getPosition = function() { if (this.fromLonLat_) { var e = Cesium.Ellipsoid.WGS84.cartesianToCartographic(this.cam_.position); return this.fromLonLat_([j(e.longitude), j(e.latitude)]) } }, t.setAltitude = function(e) {
            ...
            }, t.getAltitude = function() { return Cesium.Ellipsoid.WGS84.cartesianToCartographic(this.cam_.position).height }, t.updateCamera_ = function() {
                if (this.view_ && this.toLonLat_) {
                    var e = this.view_.getCenter();
                    if (e) {
                        var t = this.toLonLat_(e),
                            i = new Cesium.Cartographic(k(t[0]), k(t[1]));
                        ...
                        this.cam_.setView({ destination: r, orientation: o }), this.cam_.moveBackward(this.distance_), this.checkCameraChange(!0)
                    }
                }
                ...
                if (this.view_ && this.toLonLat_) {
                    ...
                    if (null != e) {
                        ...
                        this.distance_ = this.calcDistanceForResolution(i || 0, k(t[1])), this.updateCamera_()
                    }
                }
                ...
                if (this.view_ && this.fromLonLat_) {
                    ...
                    if (this.view_.setCenter(this.fromLonLat_([j(s.longitude), j(s.latitude)])), this.view_.setResolution(this.calcResolutionForDistance(this.distance_, s ? s.latitude : 0)), i) {
        ...
        D = i.n(N),
        B = function() {
            function e(e, t) { this.map = e, this.view = e.getView(), this.scene = t, this.olLayers = e.getLayerGroup().getLayers(), this.mapLayerGroup = e.getLayerGroup(), this.layerMap = {}, this.olLayerListenKeys = {}, this.olGroupListenKeys_ = {} }
            var t = e.prototype;
            return t.synchronize = function() { this.destroyAll(), this.addLayers_(this.mapLayerGroup) }, t.orderLayers = function() {}, t.addLayers_ = function(e) {
                for (var t = this, i = [{ layer: e, parents: [] }], n = function() {
                        var e = i.splice(0, 1)[0],
                            n = e.layer,
                            r = s(n).toString();
                        t.olLayerListenKeys[r] = [];
                        var a = null;
                        if (n instanceof D.a) t.listenForGroupChanges_(n), n !== t.mapLayerGroup && (a = t.createSingleLayerCounterparts(e)), a || n.getLayers().forEach((function(r) {
                            if (r) {
                                var o = { layer: r, parents: n === t.mapLayerGroup ? [] : [e.layer].concat(e.parents) };
                                i.push(o)
                            }
                        }));
                ...
                var n = this;
                this.layerMap[t] = e, this.olLayerListenKeys[t].push(o(i, "change:zIndex", (function() { return n.orderLayers() }))), e.forEach((function(e) { n.addCesiumObject(e) }))
            }, t.removeAndDestroySingleLayer_ = function(e) {
                var t = this,
                    i = s(e).toString(),
                    n = this.layerMap[i];
                return n && (n.forEach((function(e) { t.removeSingleCesiumObject(e, !1), t.destroyCesiumObject(e) })), this.olLayerListenKeys[i].forEach(M.unByKey), delete this.olLayerListenKeys[i]), delete this.layerMap[i], !!n
            }, t.unlistenSingleGroup_ = function(e) {
                if (e !== this.mapLayerGroup) {
                    var t = s(e).toString();
                    this.olGroupListenKeys_[t].forEach((function(e) { Object(M.unByKey)(e) })), delete this.olGroupListenKeys_[t], delete this.layerMap[t]
                }
                ...
                e && function() {
                    for (var i = [e]; i.length > 0;) {
                        ...
                        n instanceof D.a && (t.unlistenSingleGroup_(n), r || n.getLayers().forEach((function(e) { i.push(e) })))
                    }
                }()
                ...
                var n = [],
                    r = function() {
                        var t = this,
                            r = e.getLayers();
                        r && (n = [r.on("add", (function(e) { t.addLayers_(e.element) })), r.on("remove", (function(e) { t.removeLayer_(e.element) }))], i.push.apply(i, n))
                    }.bind(this);
                r(), i.push(e.on("change:layers", (function(e) {
                    n.forEach((function(e) {
                        var t = i.indexOf(e);
                        t >= 0 && i.splice(t, 1), Object(M.unByKey)(e)
                    })), r()
                })))
            }, t.destroyAll = function() {
                var e;
                for (e in this.removeAllCesiumObjects(!0), this.olGroupListenKeys_) { this.olGroupListenKeys_[e].forEach(M.unByKey) }
                for (e in this.olLayerListenKeys) this.olLayerListenKeys[e].forEach(M.unByKey);
    ...
    var U = function(e) {
            ...
            function n(t, i) { var n; return (n = e.call(this, t, i) || this).cesiumLayers_ = i.imageryLayers, n.ourLayers_ = new Cesium.ImageryLayerCollection, n }
            i = e, (t = n).prototype = Object.create(i.prototype), t.prototype.constructor = t, t.__proto__ = i;
            var r = n.prototype;
            return r.addCesiumObject = function(e) { this.cesiumLayers_.add(e), this.ourLayers_.add(e) }, r.destroyCesiumObject = function(e) { e.destroy() }, r.removeSingleCesiumObject = function(e, t) { this.cesiumLayers_.remove(e, t), this.ourLayers_.remove(e, !1) }, r.removeAllCesiumObjects = function(e) {
                for (var t = 0; t < this.ourLayers_.length; ++t) this.cesiumLayers_.remove(this.ourLayers_.get(t), e);
                this.ourLayers_.removeAll(!1)
            }, r.convertLayerToCesiumImageries = function(e, t) { var i = x.tileLayerToImageryLayer(this.map, e, t); return i ? [i] : null }, r.createSingleLayerCounterparts = function(e) {
                var t = this,
                    i = e.layer,
                    n = s(i).toString(),
                ...
                if (o) {
                    var a, u = [];
                    [e.layer].concat(e.parents).forEach((function(t) { u.push(t.on(["change:opacity", "change:visible"], (function() { for (var t = 0; t < o.length; ++t) x.updateCesiumLayerProperties(e, o[t]) }))) }));
                ...
                for (var e = this, t = [], i = {}, n = [this.mapLayerGroup]; n.length > 0;) {
                    ...
                    if (t.push(r), i[s(r)] = r.getZIndex() || 0, r instanceof D.a) {
                        var o = r.getLayers();
                        o && n.unshift.apply(n, o.getArray())
                    }
                }! function(e, t) {
                    for (var i = e.length, n = Array(e.length), r = 0; r < i; r++) n[r] = { index: r, value: e[r] };
                    n.sort((function(e, i) { return t(e.value, i.value) || e.index - i.index }));
                    for (var o = 0; o < e.length; o++) e[o] = n[o].value
                }(t, (function(e, t) { return i[s(e)] - i[s(t)] })), t.forEach((function(t) {
                    var i = s(t).toString(),
                        n = e.layerMap[i];
                    n && n.forEach((function(t) { e.raiseToTop(t) }))
                }))
            }, r.raiseToTop = function(e) { this.cesiumLayers_.raiseToTop(e) }, n
        }(B),
        H = (i(3), i(19), i(5)),
        z = i.n(H),
        W = i(6),
        ...
        ne = function() {
            function e(e, t) {
                var i = new Cesium.BillboardCollection({ scene: t }),
                    n = new Cesium.PrimitiveCollection;
                this.olListenKeys = [], this.rootCollection_ = new Cesium.PrimitiveCollection, this.context = { projection: e, billboards: i, featureToCesiumMap: {}, primitives: n }, this.rootCollection_.add(i), this.rootCollection_.add(n)
            }
            var t = e.prototype;
            return t.destroy = function() { this.olListenKeys.forEach(M.unByKey), this.olListenKeys.length = 0 }, t.getRootPrimitive = function() { return this.rootCollection_ }, e
        }();

    function re(e, t) { var i; if ("undefined" == typeof Symbol || null == e[Symbol.iterator]) { if (Array.isArray(e) || (i = function(e, t) { if (!e) return; if ("string" == typeof e) return oe(e, t); var i = Object.prototype.toString.call(e).slice(8, -1); "Object" === i && e.constructor && (i = e.constructor.name); if ("Map" === i || "Set" === i) return Array.from(e); if ("Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i)) return oe(e, t) }(e)) || t && e && "number" == typeof e.length) { i && (e = i); var n = 0; return function() { return n >= e.length ? { done: !0 } : { done: !1, value: e[n++] } } } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.") } return (i = e[Symbol.iterator]()).next.bind(i) }
    ...
    var ae = function() {
        function e(e) { this.scene = e, this.boundOnRemoveOrClearFeatureListener_ = this.onRemoveOrClearFeature_.bind(this), this.defaultBillboardEyeOffset_ = new Cesium.Cartesian3(0, 0, 10) }
        var t = e.prototype;
        return t.onRemoveOrClearFeature_ = function(e) {
        ...
        }, t.setReferenceForPicking = function(e, t, i) { i.olLayer = e, i.olFeature = t }, t.createColoredPrimitive = function(e, t, i, n, r, o) {
            var a = { flat: !0, renderState: { depthTest: { enabled: !0 } } };
            void 0 !== o && (a.renderState || (a.renderState = {}), a.renderState.lineWidth = o);
            var s, u = function(e, t) { var i = new Cesium.GeometryInstance({ geometry: e }); return !t || t instanceof Cesium.ImageMaterialProperty || (i.attributes = { color: Cesium.ColorGeometryInstanceAttribute.fromColor(t) }), i }(n, r);
            if (this.getHeightReference(e, t, i) === Cesium.HeightReference.CLAMP_TO_GROUND) {
                ...
                s = new Cesium.GroundPrimitive({ geometryInstances: u })
            } else s = new Cesium.Primitive({ geometryInstances: u });
            if (r instanceof Cesium.ImageMaterialProperty) {
                var c = r.image.getValue().toDataURL();
                s.appearance = new Cesium.MaterialAppearance({ flat: !0, renderState: { depthTest: { enabled: !0 } }, material: new Cesium.Material({ fabric: { type: "Image", uniforms: { image: c } } }) })
        ...
        }, t.extractLineWidthFromOlStyle = function(e) { var t = e.getStroke() ? e.getStroke().getWidth() : void 0; return void 0 !== t ? t : 1 }, t.wrapFillAndOutlineGeometries = function(e, t, i, n, r, o) {
            ...
            return s && o.add(s), o
        }, t.csAddBillboard = function(e, t, i, n, r, o) { t.eyeOffset || (t.eyeOffset = this.defaultBillboardEyeOffset_); var a = e.add(t); return this.setReferenceForPicking(i, n, a), a }, t.olCircleGeometryToCesium = function(e, t, i, n, r) {
            var o = this,
            ...
            var c, h, m = Cesium.Cartesian3.distance(a, l),
                d = new Cesium.CircleGeometry({ center: a, radius: m, height: s });
            if (this.getHeightReference(e, t, i) === Cesium.HeightReference.CLAMP_TO_GROUND) {
                var g = this.extractLineWidthFromOlStyle(r);
                if (g) {
                    var f = Object(J.circular)(i.getCenter(), m),
                        p = x.ol4326CoordinateArrayToCsCartesians(f.getLinearRing(0).getCoordinates());
                    if (u(this.scene))(c = new Cesium.GroundPolylinePrimitive({ geometryInstances: new Cesium.GeometryInstance({ geometry: new Cesium.GroundPolylineGeometry({ positions: p, width: g }) }), appearance: new Cesium.PolylineMaterialAppearance({ material: this.olStyleToCesium(t, r, !0) }), classificationType: Cesium.ClassificationType.TERRAIN })).readyPromise.then((function() { o.setReferenceForPicking(e, t, c._primitive) }));
                    else {
                        var v = this.extractColorFromOlStyle(r, !0);
                        c = this.createStackedGroundCorridors(e, t, g, v, p)
                    }
                }
            } else h = new Cesium.CircleOutlineGeometry({ center: a, radius: m, extrudedHeight: s, height: s });
            ...
            for (var o = [], a = 0, s = 0, u = [1e3, 4e3, 16e3, 64e3, 254e3, 1e6, 1e7]; s < u.length; s++) {
                for (var l, c = u[s], h = { width: i *= 2.14, vertexFormat: Cesium.VertexFormat.POSITION_ONLY }, m = re(r); !(l = m()).done;) {
                    var d = l.value;
                    h.positions = d, o.push(new Cesium.GeometryInstance({ geometry: new Cesium.CorridorGeometry(h), attributes: { color: Cesium.ColorGeometryInstanceAttribute.fromColor(n), distanceDisplayCondition: new Cesium.DistanceDisplayConditionGeometryInstanceAttribute(a, c - 1) } }))
                }
                a = c
            }
            return new Cesium.GroundPrimitive({ geometryInstances: o })
            ...
            if (c !== Cesium.HeightReference.CLAMP_TO_GROUND || u(this.scene)) {
                var h = new Cesium.PolylineMaterialAppearance({ material: this.olStyleToCesium(t, r, !0) }),
                    m = { positions: s, width: l },
                    d = { appearance: h };
                if (c === Cesium.HeightReference.CLAMP_TO_GROUND) {
                    var g = new Cesium.GroundPolylineGeometry(m);
                    d.geometryInstances = new Cesium.GeometryInstance({ geometry: g }), (a = new Cesium.GroundPolylinePrimitive(d)).readyPromise.then((function() { o.setReferenceForPicking(e, t, a._primitive) }))
                } else {
                    m.vertexFormat = h.vertexFormat;
                    var f = new Cesium.PolylineGeometry(m);
                    d.geometryInstances = new Cesium.GeometryInstance({ geometry: f }), a = new Cesium.Primitive(d)
                }
            } else {
            ...
            if (5 == i.getCoordinates()[0].length && "rectangle" === t.getGeometry().get("olcs.polygon_kind")) {
                var h = i.getCoordinates()[0],
                    m = Object(ee.boundingExtent)(h),
                    d = Cesium.Rectangle.fromDegrees(m[0], m[1], m[2], m[3]),
                    g = 0;
                if (3 == h[0].length)
                    for (var f = 0; f < h.length; f++) g = Math.max(g, h[f][2]);
                a = new Cesium.RectangleGeometry({ ellipsoid: Cesium.Ellipsoid.WGS84, rectangle: d, height: g }), s = new Cesium.RectangleOutlineGeometry({ ellipsoid: Cesium.Ellipsoid.WGS84, rectangle: d, height: g })
            } else {
                for (var p = i.getLinearRings(), v = {}, C = v, y = 0; y < p.length; ++y) {
                    var _ = p[y].getCoordinates(),
                        b = x.ol4326CoordinateArrayToCsCartesians(_);
                    0 == y ? v.positions = b : (v.holes || (v.holes = []), v.holes.push({ positions: b }))
                }
                if (a = new Cesium.PolygonGeometry({ polygonHierarchy: C, perPositionHeight: !0 }), c === Cesium.HeightReference.CLAMP_TO_GROUND) {
                    ...
                    if (w > 0) {
                        ...
                        if (u(this.scene)) {
                            for (var L, P = new Cesium.PolylineMaterialAppearance({ material: this.olStyleToCesium(t, r, !0) }), R = [], E = re(S); !(L = E()).done;) {
                                var O = L.value,
                                    A = new Cesium.GroundPolylineGeometry({ positions: O, width: w });
                                R.push(new Cesium.GeometryInstance({ geometry: A }))
                            }
                            var G = { appearance: P, geometryInstances: R };
                            (l = new Cesium.GroundPolylinePrimitive(G)).readyPromise.then((function() { o.setReferenceForPicking(e, t, l._primitive) }))
                        } else {
                            var I = this.extractColorFromOlStyle(r, !0);
                            l = this.createStackedGroundCorridors(e, t, w, I, S)
                        }
                    }
                } else s = new Cesium.PolygonOutlineGeometry({ polygonHierarchy: v, perPositionHeight: !0 })
            }
            var M = this.wrapFillAndOutlineGeometries(e, t, i, a, s, r);
            return l && M.add(l), this.addTextStyle(e, t, i, r, M)
                ...
                h = function() {
                    if (l && (l instanceof HTMLCanvasElement || l instanceof Image || l instanceof HTMLImageElement)) {
                        ...
                        var m = o.getScale(),
                            ...
                            g = { image: l, color: n, scale: m, heightReference: d, position: c };
                        if (Object.assign(g, t.get("cesiumOptions")), o instanceof $.a) {
                            var f = o.getAnchor();
            ...
            if (l instanceof Image && ! function(e) { return "" != e.src && 0 != e.naturalHeight && 0 != e.naturalWidth && e.complete }(l)) {
                var m = !1,
                    d = e.getSource();
                ...
                var f = s(t);
                g[f] && g[f](), g[f] = function() { m = !0 };
                l.addEventListener("load", (function e() { l.removeEventListener("load", e), a.isDestroyed() || m || h() }))
            } else h()
            ...
            if (u) {
                ...
                if (l) {
                    var c = l(),
                        h = Object.assign({}, { scene: this.scene }, c.cesiumOptions),
                        m = Cesium.Model.fromGltf(h);
                    (s = new Cesium.PrimitiveCollection).add(m), c.debugModelMatrix && s.add(new Cesium.DebugModelMatrixPrimitive({ modelMatrix: c.debugModelMatrix }))
            ...
            var s, u = this,
                l = function(i, o) { var a = new Cesium.PrimitiveCollection; return i.forEach((function(i) { a.add(o(e, t, i, n, r)) })), a };
            switch (i.getType()) {
                case "MultiPoint":
                    ...
                    return s.forEach((function(i) { u.olPointGeometryToCesium(e, t, i, n, r, o, a) })), null;
            ...
            var r = n.getText();
            if (!r) return null;
            var o = new Cesium.LabelCollection({ scene: this.scene }),
                a = Object(ee.getCenter)(i.getExtent());
            ...
            return o = x.convertColorToCesium(o), i && r.getLineDash() ? Cesium.Material.fromType("Stripe", { horizontal: !1, repeat: 500, evenColor: o, oddColor: new Cesium.Color(0, 0, 0, 0) }) : Cesium.Material.fromType("Color", { color: o })
        }, t.computePlainStyle = function(e, t, i, n) {
            var r = t.getStyleFunction(),
                o = null;
            return r && (o = r(t, n)), !o && i && (o = i(t, n)), o ? Array.isArray(o) ? o : [o] : null
        }, t.getGeometryFromFeature = function(e, t, i) { if (i) return i; var n = e.get("olcs.3d_geometry"); if (n && n instanceof Q.a) return n; if (t) { var r = t.getGeometryFunction()(e); if (r instanceof Q.a) return r } return e.getGeometry() }, t.olFeatureToCesium = function(e, t, i, n, r) {
            var o = this,
            ...
            var o = e.getSource();
            o instanceof z.a && (o = o.getSource());
            for (var a = o.getFeatures(), u = new ne(n, this.scene), l = u.context, c = 0; c < a.length; ++c) {
                var h = a[c];
                if (h) {
    ...
    var se = function(e) {
            ...
            function n(t, i, n) { var r; return (r = e.call(this, t, i) || this).converter = n || new ae(i), r.csAllPrimitives_ = new Cesium.PrimitiveCollection, i.primitives.add(r.csAllPrimitives_), r.csAllPrimitives_.destroyPrimitives = !1, r }
            i = e, (t = n).prototype = Object.create(i.prototype), t.prototype.constructor = t, t.__proto__ = i;
            var r = n.prototype;
            return r.addCesiumObject = function(e) { e.getRootPrimitive().counterpart = e, this.csAllPrimitives_.add(e.getRootPrimitive()) }, r.destroyCesiumObject = function(e) { e.getRootPrimitive().destroy() }, r.removeSingleCesiumObject = function(e, t) { e.destroy(), this.csAllPrimitives_.destroyPrimitives = t, this.csAllPrimitives_.remove(e.getRootPrimitive()), this.csAllPrimitives_.destroyPrimitives = !1 }, r.removeAllCesiumObjects = function(e) {
                ...
                var t = this,
                    i = e.layer;
                if (!(i instanceof K.a) || i instanceof Z.a) return null;
                var n = i.getSource();
                if (n instanceof z.a && (n = n.getSource()), !n) return null;
                var r = this.view,
                    a = {},
                    u = this.converter.olVectorLayerToCesium(i, r, a),
                    l = u.getRootPrimitive(),
                    c = u.olListenKeys;
                [e.layer].concat(e.parents).forEach((function(i) { c.push(o(i, "change:visible", (function() { t.updateLayerVisibility(e, l) }))) })), this.updateLayerVisibility(e, l);
                var h = function(e) {
                        var t = u.context,
                    ...
                    m = function(e) {
                        ...
                        n && (delete i.featureToCesiumMap[t], n.forEach((function(e) { e instanceof Cesium.Billboard && i.billboards.remove(e) })));
                        var r = a[t];
                        delete a[t], r && l.remove(r)
                    }.bind(this);
                return c.push(o(n, "addfeature", (function(e) { h(e.feature) }))), c.push(o(n, "removefeature", (function(e) { m(e.feature) }))), c.push(o(n, "changefeature", (function(e) {
                    var t = e.feature;
                    m(t), h(t)
                }))), u ? [u] : null
            }, n
    ...
    var he = function(e) {
            ...
            function r(t) {
                var i, n = t.parent;
                (i = e.call(this, n.getOptions()) || this).scenePostRenderListenerRemover_ = null, i.scene_ = t.scene, i.synchronizer_ = t.synchronizer, i.parent_ = n, i.positionWGS84_ = void 0, i.observer_ = new MutationObserver(i.handleElementChanged.bind(function(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e }(i))), i.attributeObserver_ = [], i.listenerKeys_ = [];
                var r = function(e) { return i.setPropertyFromEvent_(e) };
            ...
            return o.observeTarget_ = function(e) {
                if (this.observer_) {
                    this.observer_.disconnect(), this.observer_.observe(e, { attributes: !1, childList: !0, characterData: !0, subtree: !0 }), this.attributeObserver_.forEach((function(e) { e.disconnect() })), this.attributeObserver_.length = 0;
                    for (var t = 0; t < e.childNodes.length; t++) {
                        var i = e.childNodes[t];
                        if (1 === i.nodeType) {
                            var n = new MutationObserver(this.handleElementChanged.bind(this));
                            n.observe(i, { attributes: !0, subtree: !0 }), this.attributeObserver_.push(n)
                        }
                    }
                }
            }, o.setPropertyFromEvent_ = function(e) { e.target && e.key && this.set(e.key, e.target.get(e.key)) }, o.getScene = function() { return this.scene_ }, o.handleMapChanged = function() {
                var e;
                ...
                function e(t, i) {
                    var n = t.cloneNode();
                    i && i.appendChild(n), t.nodeType != Node.TEXT_NODE && n.addEventListener("click", (function(e) { t.dispatchEvent(new MouseEvent("click", e)), e.stopPropagation() }));
                    for (var r = t.childNodes, o = 0; o < r.length; o++) r[o] && e(r[o], n);
                    return n
                }! function(e) { for (; e.lastChild;) e.removeChild(e.lastChild) }(this.element);
                var t = this.getElement();
                if (t && t.parentNode && t.parentNode.childNodes)
                    for (var i, n = le(t.parentNode.childNodes); !(i = n()).done;) {
                        var r = e(i.value, null);
            ...
            }, o.destroy = function() { this.scenePostRenderListenerRemover_ && this.scenePostRenderListenerRemover_(), this.observer_ && this.observer_.disconnect(), Object(M.unByKey)(this.listenerKeys_), this.listenerKeys_.splice(0), this.element.removeNode ? this.element.removeNode(!0) : this.element.remove(), this.element = null }, r
        }(i.n(ue).a),
        me = function() {
            function e(e, t) {
                var i = this;
            ...
            return t.getOverlayContainerStopEvent = function() { return this.overlayContainerStopEvent_ }, t.getOverlayContainer = function() { return this.overlayContainer_ }, t.synchronize = function() { this.destroyAll(), this.addOverlays(), this.overlays_.on("add", this.addOverlayFromEvent_.bind(this)), this.overlays_.on("remove", this.removeOverlayFromEvent_.bind(this)) }, t.addOverlayFromEvent_ = function(e) {
                ...
                var e = this;
                Object.keys(this.overlayMap_).forEach((function(t) { e.overlayMap_[t].destroy(), delete e.overlayMap_[t] }))
            }, e
        }();
    ...
    var ge = function() {
            function e(t) {
                this.autoRenderLoop_ = null, this.map_ = t.map, this.time_ = t.time || function() { return Cesium.JulianDate.now() }, this.to4326Transform_ = Object(n.getTransform)(this.map_.getView().getProjection(), "EPSG:4326"), this.resolutionScale_ = 1, this.canvasClientWidth_ = 0, this.canvasClientHeight_ = 0, this.resolutionScaleChanged_ = !0;
                ...
                var o = t.target || this.map_.getViewport();
                if ("string" == typeof o && (o = document.getElementById(o)), o.appendChild(this.container_), this.isOverMap_ = !o, this.isOverMap_ && t.stopOpenLayersEventsPropagation)
                    for (var a = ["click", "dblclick", "mousedown", "touchstart", "MSPointerDown", "pointerdown", "mousewheel", "wheel"], s = 0, u = a.length; s < u; ++s) this.container_.addEventListener(a[s], (function(e) { return e.stopPropagation() }));
                this.canvas_ = document.createElement("CANVAS");
                var l = document.createAttribute("style");
                l.value = i, this.canvas_.setAttributeNode(l), c.supportsImageRenderingPixelated() && (this.canvas_.style.imageRendering = c.imageRenderingValue()), this.canvas_.oncontextmenu = function() { return !1 }, this.canvas_.onselectstart = function() { return !1 }, this.container_.appendChild(this.canvas_), this.enabled_ = !1, this.pausedInteractions_ = [], this.hiddenRootGroup_ = null;
                var h = void 0 !== t.sceneOptions ? t.sceneOptions : {};
                h.canvas = this.canvas_, h.scene3DOnly = !0, this.scene_ = new Cesium.Scene(h);
                var m = this.scene_.screenSpaceCameraController;
                m.tiltEventTypes.push({ eventType: Cesium.CameraEventType.LEFT_DRAG, modifier: Cesium.KeyboardEventModifier.SHIFT }), m.tiltEventTypes.push({ eventType: Cesium.CameraEventType.LEFT_DRAG, modifier: Cesium.KeyboardEventModifier.ALT }), m.enableLook = !1, this.scene_.camera.constrainedAxis = Cesium.Cartesian3.UNIT_Z, this.camera_ = new V(this.scene_, this.map_), this.globe_ = new Cesium.Globe(Cesium.Ellipsoid.WGS84), this.globe_.baseColor = Cesium.Color.WHITE, this.scene_.globe = this.globe_, this.scene_.skyAtmosphere = new Cesium.SkyAtmosphere;
                var d = new Cesium.SingleTileImageryProvider({ url: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=", rectangle: Cesium.Rectangle.fromDegrees(0, 0, 1, 1) });
                this.globe_.imageryLayers.addImageryProvider(d, 0), this.dataSourceCollection_ = new Cesium.DataSourceCollection, this.dataSourceDisplay_ = new Cesium.DataSourceDisplay({ scene: this.scene_, dataSourceCollection: this.dataSourceCollection_ });
                var g = t.createSynchronizers ? t.createSynchronizers(this.map_, this.scene_, this.dataSourceCollection_) : [new U(this.map_, this.scene_), new se(this.map_, this.scene_), new me(this.map_, this.scene_)];
                this.handleResize_();
                for (var f = g.length - 1; f >= 0; --f) g[f].synchronize();
            ...
            return o.render_ = function() { void 0 !== this.renderId_ && (cancelAnimationFrame(this.renderId_), this.renderId_ = void 0), !this.enabled_ && !this.warmingUp_ || this.blockCesiumRendering_ || (this.renderId_ = requestAnimationFrame(this.onAnimationFrame_.bind(this))) }, o.onAnimationFrame_ = function(e) {
                ...
                if (this.enabled_ !== e)
                    if (this.enabled_ = e, this.container_.style.visibility = this.enabled_ ? "visible" : "hidden", this.enabled_) {
                        if (this.throwOnUnitializedMap_(), this.isOverMap_) {
                            (t = this.map_.getInteractions()).forEach((function(e, t, n) { i.pausedInteractions_.push(e) })), t.clear(), this.map_.addInteraction = function(e) { return i.pausedInteractions_.push(e) }, this.map_.removeInteraction = function(e) { return i.pausedInteractions_ = i.pausedInteractions_.filter((function(t) { return t !== e })) };
                ...
                if (!this.enabled_) {
                    ...
                    o.height < e && (o.height = e, r.position = n.cartographicToCartesian(o)), this.warmingUp_ = !0, this.render_(), setTimeout((function() { i.warmingUp_ = !1 }), t)
                }
            }, o.setBlockCesiumRendering = function(e) { this.blockCesiumRendering_ !== e && (this.blockCesiumRendering_ = e, this.render_()) }, o.enableAutoRenderLoop = function() { this.autoRenderLoop_ || (this.autoRenderLoop_ = new I(this)) }, o.getAutoRenderLoop = function() { return this.autoRenderLoop_ }, o.setResolutionScale = function(e) {
            ...
            }, o.setTargetFrameRate = function(e) { this.targetFrameRate_ !== e && (this.targetFrameRate_ = e, this.render_()) }, o.throwOnUnitializedMap_ = function() {
                ...
                key: "trackedFeature",
                get: function() { return this.trackedFeature_ },
                set: function(e) {
                    if (this.trackedFeature_ !== e) {
                        ...
                        var i = this.to4326Transform_,
                            n = { position: new Cesium.CallbackProperty((function(t, n) { return r = e.getGeometry().getCoordinates(), o = i(r, void 0, r.length), x.ol4326CoordinateToCesiumCartesian(o); var r, o }), !1), point: { pixelSize: 1, color: Cesium.Color.TRANSPARENT } };
                        this.trackedEntity_ = this.dataSourceDisplay_.defaultDataSource.entities.add(n)
                    }
                }
            }]) && de(t.prototype, i), r && de(t, r), e
        }(),
        fe = function() {
            function e(e) { this.promise, this.url_ = e }
            return e.prototype.load = function() {
                var e = this;
                return this.promise || (this.promise = new Promise((function(t, i) {
                    var n = document.createElement("script");
                    n.onload = function() { return t() }, n.onerror = function() { return i() }, document.head.appendChild(n), n.src = e.url_
                }))), this.promise
            }, e
        }();

    function pe(e, t, i) {
        return (pe = ve() ? Reflect.construct : function(e, t, i) {
            var n = [null];
            n.push.apply(n, t);
            var r = new(Function.bind.apply(e, n));
            return i && Ce(r, i.prototype), r
        }).apply(null, arguments)
    }

    function ve() { if ("undefined" == typeof Reflect || !Reflect.construct) return !1; if (Reflect.construct.sham) return !1; if ("function" == typeof Proxy) return !0; try { return Date.prototype.toString.call(Reflect.construct(Date, [], (function() {}))), !0 } catch (e) { return !1 } }

    function Ce(e, t) { return (Ce = Object.setPrototypeOf || function(e, t) { return e.__proto__ = t, e })(e, t) }
    var ye = function(e) {
            var t, i;
            ...
            function n(t, i) {
                ...
                return (n = e.call(this) || this).cesiumUrl_ = t, n.map = o, n.cameraExtentInRadians = a || null, n.boundingSphere_, n.blockLimiter_ = !1, n.promise_, n.ol3d, n.cesiumInitialTilt_ = k(50), n.fogDensity = 1e-4, n.fogSSEFactor = 25, n.minimumZoomDistance = 2, n.maximumZoomDistance = 1e7, n.limitCameraToBoundingSphereRatio = function(e) { return e > 3e3 ? 9 : 3 }, n
            }
            i = e, (t = n).prototype = Object.create(i.prototype), t.prototype.constructor = t, t.__proto__ = i;
            var r = n.prototype;
            return r.load = function() {
                var e = this;
                if (!this.promise_) {
                    var t = new fe(this.cesiumUrl_);
                    this.promise_ = t.load().then((function() { return e.onCesiumLoaded() }))
                }
                return this.promise_
            }, r.onCesiumLoaded = function() {
                if (this.cameraExtentInRadians) {
                    var e = pe(Cesium.Rectangle, this.cameraExtentInRadians);
                ...
                if (this.boundingSphere_ && !this.blockLimiter_) {
                    ...
                    if (Cesium.Cartesian3.distance(this.boundingSphere_.center, i) > this.boundingSphere_.radius * r) {
                        ...
                        var o = function() { return e.blockLimiter_ = !1 };
                        t.flyToBoundingSphere(this.boundingSphere_, { complete: o, cancel: o })
                    }
                }
            }, r.toggle3d = function() {
                var e = this;
                return this.load().then((function(t) {
                    var i = t.getEnabled(),
                        n = t.getCesiumScene();
                    return i ? x.resetToNorthZenith(e.map, n).then((function() { t.setEnabled(!1), e.dispatchEvent("toggle") })) : (t.setEnabled(!0), e.dispatchEvent("toggle"), x.rotateAroundBottomCenter(n, e.cesiumInitialTilt_))
                }))
                ...
                return this.load().then((function(a) {
                    var s = a.getEnabled(),
                        ...
                        c = { heading: Cesium.Math.toRadians(n), pitch: Cesium.Math.toRadians(r), roll: 0 };
                    s || (a.setEnabled(!0), o.dispatchEvent("toggle")), u.setView({ destination: l, orientation: c })
                }))
            }, r.is3dEnabled = function() { return !!this.ol3d && this.ol3d.getEnabled() }, r.getHeading = function() { return this.map && this.map.getView().getRotation() || 0 }, r.getTiltOnGlobe = function() { var e = this.ol3d.getCesiumScene(); return -x.computeSignedTiltAngleOnGlobe(e) }, r.setHeading = function(e) {
                var t = this.ol3d.getCesiumScene(),
                    i = x.pickBottomPoint(t);
                i && x.setHeadingUsingBottomCenter(t, e, i)
            }, r.getOl3d = function() { return this.ol3d }, r.getOlView = function() { return this.map.getView() }, r.getCesiumViewMatrix = function() { return this.ol3d.getCesiumScene().camera.viewMatrix }, r.getCesiumScene = function() { return this.ol3d.getCesiumScene() }, r.flyToRectangle = function(e, t) {
                var i = this;
                void 0 === t && (t = 0);
                var n = this.getCesiumScene().camera,
                    r = n.getRectangleCameraCoordinates(e),
                    o = Cesium.Cartesian3.magnitude(r) + t;
                return Cesium.Cartesian3.normalize(r, r), Cesium.Cartesian3.multiplyByScalar(r, o, r), new Promise((function(e, t) { i.cameraExtentInRadians ? n.flyTo({ destination: r, complete: function() { return e() }, cancel: function() { return t() }, endTransform: Cesium.Matrix4.IDENTITY }) : t() }))
            }, r.getCameraExtentRectangle = function() { if (this.cameraExtentInRadians) return pe(Cesium.Rectangle, this.cameraExtentInRadians) }, n
        }(F.a),
        _e = (t.default = ge, window.olcs = {});
    _e.OLCesium = ge, _e.AbstractSynchronizer = B, _e.RasterSynchronizer = U, _e.VectorSynchronizer = se, _e.core = x, _e.core.OLImageryProvider = E, _e.core.VectorLayerCounterpart = ne, _e.contrib = {}, _e.contrib.LazyLoader = fe, _e.contrib.Manager = ye
}]);
